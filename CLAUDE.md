...
| `gui/renderer/src/components/GameList.tsx` | Legacy table view (no longer rendered by default — replaced by ConsoleGrid + GameGrid in issue #304). Keep for reference; may be removed in a future cleanup |
