...
_IMPORT_CONSOLES = [
    {"key": "gba",     "label": "Game Boy Advance",          "abbr": "GBA",
     ...
     "standalones": [_MGBA],
     "folder_names": ["gba", "gameboy advance"],
    ...
    {"key": "gb",      "label": "Game Boy / Game Boy Color", "abbr": "GB",
     ...
     "standalones": [_MGBA],
     "folder_names": ["gb", "gbc", "gameboy", "gameboy color"],
    ...
    {"key": "snes",    "label": "Super Nintendo (SNES)",      "abbr": "SNES",
     ...
     "folder_names": ["snes", "super nintendo"],
    ...
    {"key": "genesis", "label": "Sega Genesis / Mega Drive",  "abbr": "Genesis",
     ...
     "folder_names": ["genesis", "megadrive", "mega drive", "md", "sega genesis"],
    ...
    {"key": "sms",     "label": "Master System / Game Gear",  "abbr": "SMS",
     ...
     "folder_names": ["sms", "mastersystem", "master system", "gamegear", "game gear"],
     "standalones": [], "suggestions": ["RetroArch with Genesis Plus GX core"]},
    {"key": "pce",     "label": "PC Engine",                  "abbr": "PCE",
     "system_keys": ["pce"],
     "databases": ["NEC - PC Engine - TurboGrafx 16", "NEC - PC Engine SuperGrafx"],
     "folder_names": ["pce", "pcengine", "turbografx", "turbografx16", "tg16"],
    ...
    {"key": "psx",     "label": "PlayStation",                "abbr": "PSX",
     ...
     "folder_names": ["psx", "ps1", "playstation"],
    ...
    {"key": "switch",  "label": "Nintendo Switch",            "abbr": "Switch",
     ...
     "folder_names": ["switch", "nintendo switch"],
