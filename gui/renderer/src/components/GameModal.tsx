...
export default function GameModal({ target, onClose, onChanged, onLaunch }: {
  ...
  const { slug, name, gameConsole, gameIsLocal, savePath, canPlay } = target;
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" style={{ width: 760, maxWidth: "92vw" }} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ maxHeight: "70vh", overflowY: "auto" }}>
          ...
          {tab === "history" && (
            <SaveHistory embedded slug={slug} name={name} savePath={savePath} onClose={onClose} onRestored={onChanged} />
          )}
          {tab === "run" && (
