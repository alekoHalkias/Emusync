...
export default function GameList({ onAdd, onEdit, onPlay, onShowConsoleSettings }: Props): React.ReactElement {
    ...
    <>
      <div className="section-header">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button className="btn btn-ghost" onClick={onShowConsoleSettings}>⚙ Console Settings</button>
