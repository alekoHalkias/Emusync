...
contextBridge.exposeInMainWorld("emusync", {
  ...
  artwork: {
    ...
    resolveMatch: (slug: string, gameName: string): Promise<{ id: number; name: string } | null> =>
      ipcRenderer.invoke("artwork:resolveMatch", slug, gameName),
